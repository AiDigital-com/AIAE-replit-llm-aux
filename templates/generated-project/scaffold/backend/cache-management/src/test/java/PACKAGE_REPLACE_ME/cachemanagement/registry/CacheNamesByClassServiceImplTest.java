...
class CacheNamesByClassServiceImplTest {
	...
	@Test
	void shouldResolveCacheNamesByFullyQualifiedClassNameTest() {
		...
		// When / Then:
			assertThat(service.getCacheNamesByClassName("java.lang.String")).containsExactly("a", "b");
			assertThat(service.getCacheNamesByClassName("java.lang.Integer")).containsExactly("c");
			assertThat(service.getCacheNamesByClassName("example.Unknown")).isEmpty();
