...
// changelog lives in the `migrations` module at
// migrations/src/main/resources/db/changelog/changes/0001-usage-events.xml — that's
// intentional: every migration in the project sits in `migrations`, never alongside
